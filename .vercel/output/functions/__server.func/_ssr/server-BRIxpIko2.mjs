...
import { n as createCsrfMiddleware } from "./server-BRIxpIko.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D9WWFCSZ.mjs");
...
var manifest = { "34f1eaf6a46862558f0defb8995d3ed48031a8621afa0339c7adacff7adbf498": {
	functionName: "sendInquiryEmail_createServerFn_handler",
	importer: () => import("./send-inquiry-Da63nTwJ.mjs")
} };
